...
def darw_3d_board(img, board, rvec, tvec, A, corners, textures, mode = '2d', fill_grid_img = None):
    if mode == 'letter':
...
def get_extrinsic_parameters(img, num_x, num_y, A): #camera caliberation
...
def within_boundary(mouse_x,mouse_y,z,rvecs,tvecs,A):
